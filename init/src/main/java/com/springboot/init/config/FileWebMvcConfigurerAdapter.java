...
public class FileWebMvcConfigurerAdapter implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        registry.addResourceHandler("/excelfile/**").addResourceLocations("file:E:/OPSResources/excel/");
        registry.addResourceHandler("/localimage/**").addResourceLocations("file:E:/OPSResources/image/");
    }
}
